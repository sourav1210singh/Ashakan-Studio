            ...
            <nav className="w-full flex-1 flex flex-col">
              {[
                ...
                <div key={item.label} className="border-b border-dark/10 group relative flex-1 flex min-h-0">
                  ...
                  <button
                    onClick={() => handleNavClick(item.href)}
                    className="relative z-20 w-full self-stretch flex items-center text-left font-hero-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-dark tracking-[0.06em] px-6 sm:px-10 lg:px-16 transition-colors duration-300 group-hover:text-white uppercase font-black"
