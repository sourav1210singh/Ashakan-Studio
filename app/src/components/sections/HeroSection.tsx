        ...
        <div className="text-center">
          ...
          >
            ...
            <InlineCutout
              ...
              className="inline-block mr-[-26px] mt-[-46px] left-[-46px] md:mr-[-90px] md:mt-[-90px] md:left-[-64px] lg:mr-[-170px] lg:mt-[-140px] lg:left-[-140px] xl:left-[-84px]"
            ...
            <InlineCutout
              ...
              className="inline-block ml-[-44px] mt-[-22px] top-[10px] md:ml-[-96px] md:mt-[-50px] md:top-[25px] lg:ml-[-110px] lg:mt-[-80px] lg:top-[40px] xl:ml-[-162px]"
