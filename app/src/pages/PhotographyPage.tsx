...
const categoryGallery: Record<string, { src: string; alt: string }[]> = {
  ...
  "the-arts": [
    ...
    { src: "/images/categories/the-arts/the-art-15.jpg", alt: "Performing arts - movement" },
    { src: "/images/categories/the-arts/the-art-47.jpg", alt: "Performing arts - editorial" },
    { src: "/images/categories/the-arts/_abstract-1599.jpg", alt: "Abstract movement composition" },
    ...
    { src: "/images/categories/the-arts/alyssa-luck-1098.jpg", alt: "Alyssa Luck - movement portrait" },
    ...
    { src: "/images/categories/the-arts/ava-ramirez-202.jpg", alt: "Ava Ramirez - movement" },
    ...
    { src: "/images/categories/the-arts/kinetic-symphony-3317-edit-2.jpg", alt: "Kinetic Symphony - movement" },
    { src: "/images/categories/the-arts/lauren-anderson-2490-edit.jpg", alt: "Lauren Anderson - performance editorial" },
    { src: "/images/categories/the-arts/leah-white_-1127.jpg", alt: "Leah White - performer" },
    { src: "/images/categories/the-arts/madison-7078-2.jpg", alt: "Madison - movement portrait" },
    { src: "/images/categories/the-arts/miranda-davis-8-7-24-023-edit.jpg", alt: "Miranda Davis - movement" },
    ...
    { src: "/images/categories/the-arts/yuriko-24149.jpg", alt: "Yuriko - editorial portrait" },
  ],
  retail: [
...
const categoryMeta: Record<string, { title: string; description: string }> = {
  "the-arts": {
    title: "THE ARTS",
    description:
      "Capturing the soul of artists and performers through expressive photography. Each frame celebrates movement, emotion, and creative expression.",
  },
  retail: {
    title: "RETAIL",
    description:
